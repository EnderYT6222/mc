...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/mc)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/mc
```

A live public deployment of this template is available at [https://mc.templates.workers.dev](https://mc.templates.workers.dev)
